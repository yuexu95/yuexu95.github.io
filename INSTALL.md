...
> Beta: You can also use the slimmed local build with a size below 100MBs and the same functionality. Just use `docker compose -f docker-compose-slim.yml up --build`
